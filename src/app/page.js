...
const navigationtop = [
  ...
  { name: 'Contact', href: 'https://holyrosarycu.org/hours-and-locations.html' },
]
              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <div className="mt-10 flex items-center gap-x-6">
                    <a
                      href="https://holyrosary.ns3web.org/"
                      className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                      Online Banking Link
                    </a>
                    <a href="https://main.financialtown.com/holyrosarycu/instant_call" className="text-sm font-semibold leading-6 text-gray-900">
                      Video Banking <span aria-hidden="true">→</span>
                    </a>
                  </div>
                </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            What are people saying about Holy Rosary?
          </p>
        </div>
